...
description: 港股模拟炒股大赛交易助手，支持行情查询、账户管理、买卖交易和历史记录查询；当用户需要查看港股行情、管理模拟账户、执行买卖操作或查询交易记录时使用
---
...
- 能力包含：行情查询、账户快照、持仓管理、买卖交易、历史记录查询
- 触发条件：用户提及港股、模拟炒股、查看行情、买入卖出、账户查询、持仓、手续费、比赛规则等
